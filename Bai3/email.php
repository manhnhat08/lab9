...
if (isset($_POST)) {
    ...
    try {
      //  $mail->SMTPDebug = 2;  // 0,1,2: chế độ debug. khi mọi cấu hình đều tớt thì chỉnh lại 0 nhé
        ...
        $nguoigui = 'nhatdnm.21it@vku.udn.vn';
        $matkhau = 'feewstrgpdwoouwc'; // đã tạo ở bước 3
        $tennguoigui = 'Chúa hề quảng nam';
        ...
        $recipients = "dunglm.21it@vku.udn.vn,viennv.21it@vku.udn.vn,tungtt2.21it@vku.udn.vn";
        ...
        // $mail->addAddress("dunglm.21it@vku.udn.vn","Khánh Hòa");
